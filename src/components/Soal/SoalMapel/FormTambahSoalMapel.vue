	...
	<div>
      ...
      <ckeditor :editor="editor" v-model="dataSoal.pertanyaan" :config="editorConfig"></ckeditor>
	      ...
	      <!-- <v-tab-item value="tab-1">
					<br>
      		<ckeditor :editor="editor" v-model="dataSoal.jawabanB" :config="editorConfig"></ckeditor>
	      </v-tab-item>
	      <v-tab-item value="tab-2">
					<br>
      		<ckeditor :editor="editor" v-model="dataSoal.jawabanC" :config="editorConfig"></ckeditor>
	      </v-tab-item>
	      <v-tab-item value="tab-3">
					<br>
      		<ckeditor :editor="editor" v-model="dataSoal.jawabanD" :config="editorConfig"></ckeditor>
	      </v-tab-item>
	      <v-tab-item value="tab-4">
					<br>
      		<ckeditor :editor="editor" v-model="dataSoal.jawabanE" :config="editorConfig"></ckeditor>
	      </v-tab-item> -->
			</v-tabs>
